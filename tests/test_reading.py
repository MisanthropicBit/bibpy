...
def test_reading_errors():
    bibpy.read_string('tests/data/bibtex_missing_requirements.bib',
                      format='bibtex')
...
def test_reading_encodings():
    ...
    bibpy.read_file('tests/data/simple_1.bib', format='relaxed',
                    encoding='ascii')
    ...
    with pytest.raises(UnicodeDecodeError):
        bibpy.read_file('tests/data/iso-8859-1.bib', format='bibtex',
                        encoding='utf-8')
